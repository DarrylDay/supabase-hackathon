			...
			<div className="flex-1 flex flex-col justify-center items-center gap-6">
				<div className="card w-11/12 bg-blue-200 border-blue-600 border-4">
					<div className="card-body flex flex-col gap-6 p-8">
						...
						<p>
							Pleaser has the ability to morph into any form. The
							more it morphs, the darker it grows and the more
							resentment it grows, because it grows farther from
							its original shape.
						</p>
						<p>
							Neutralize Pleaser and discover its secrets before
							Pleaser goes out of control
						</p>
						<button
						...
						<button
							...
							onClick={() => {
								const el =
									document.getElementById("monster_dialog");
								if (el) {
									(el as any).close();
								}
							}}
